...
const CartAddinventory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const itemDocRef = doc(db, 'inventory_02', normalizedInputId);
      ...
      setTimeout(() => {
        navigate('/inventory/cartInventoryRecords');
      }, 1500);
    } catch (err) {
  ...
  return (
    <div className="max-w-xl mx-auto mt-8 md:mt-16 p-6 md:p-8 bg-white border border-gray-200 rounded-2xl shadow-xl">
      <button
        ...
        onClick={() => navigate("/inventory/cartInventoryRecords")}
      >
        Back to Users
      </button>
...
export default CartAddinventory;