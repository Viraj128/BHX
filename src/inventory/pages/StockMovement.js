...
const StockMovement = () => { // Renamed component
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Stock Movement History</h1> {/* Updated title */}
        {/* Date Filter */}
...
export default StockMovement; // Export with the new name