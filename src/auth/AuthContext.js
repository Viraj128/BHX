...
// import React, { createContext, useContext, useState, useEffect, useCallback, useRef } from 'react';
// import { db, auth } from '../firebase/config'; // CHANGE: Added auth import
// import { doc, setDoc, serverTimestamp, getDoc } from "firebase/firestore";
// import { onAuthStateChanged, signOut } from 'firebase/auth'; // CHANGE: Added Firebase Auth methods
...
//   // CHANGE: Use Firebase Authentication to manage user sessions
//   useEffect(() => {
...
//             const authUser = {
//               uid: firebaseUser.uid, // CHANGE: Added Firebase UID
//               email: firebaseUser.email, // CHANGE: Added email from Firebase Auth
//               name: userData.name,
//               employeeID: userData.employeeID,
//               phone: userData.phone,
//               role: userData.role,
//               sessionId: sessionId,
//               loginTimestamp: Date.now(), // CHANGE: Added for session timeout tracking
//             };

//             setUser(authUser);
//             setSessionActive(true);

//             // Store in localStorage for session timeout tracking
//             localStorage.setItem('user', JSON.stringify(authUser));
//             localStorage.setItem('sessionTimestamp', Date.now().toString());
//             localStorage.setItem('sessionId', sessionId);

//             // Log login to Firestore using UID instead of phone
//             try {
//               const sessionRef = doc(db, 'userSessions', firebaseUser.uid); // CHANGE: Use UID instead of phone
...
//             await signOut(auth); // CHANGE: Sign out if no user data in Firestore
//             setUser(null);
//             setSessionActive(false);
//             clearSessionData();
//           }
...
//   useEffect(() => {
//     const handleBeforeUnload = async () => {
//       if (sessionIdRef.current && user?.uid) { // CHANGE: Use UID instead of phone
//         try {
//           const userRef = doc(db, 'userSessions', user.uid); // CHANGE: Use UID instead of phone
//           await setDoc(userRef, {
//             sessions: {
//               [sessionIdRef.current]: {
//                 logoutTime: serverTimestamp(),
...
//     // CHANGE: Sign out from Firebase Authentication
//     await signOut(auth);
//     setUser(null);
//     setSessionActive(false);
//     sessionIdRef.current = null;
...
//   // CHANGE: Update login function to use Firebase Authentication
//   const login = async (email, password) => {
//     // This assumes you're using email/password authentication
//     // If you're using a different method (e.g., custom token, phone auth), adjust accordingly
//     try {
//       const { signInWithEmailAndPassword } = await import('firebase/auth'); // Dynamic import
//       await signInWithEmailAndPassword(auth, email, password);
//       // onAuthStateChanged will handle the rest (fetching user data, setting session)
//     } catch (error) {
